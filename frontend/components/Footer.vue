...
<template>
  <div class="w-full p-5 flex justify-center items-center border-t-1 border-t-gray-600 bg-black gap-20">
    ...
    <p class="text-gray-300 text-xs self-end">
      © 2025 45KDH Trampy<br>
      Licencja GNU-GPL
    </p>
    <div class="flex flex-col">
      <p class="text-sm text-gray-300">
